...
def main():
    ...
    run_list = [
                ...
                [0.6, "neg", "drop", "shear_flow", "shear_flow_Reynolds_1e5_Schmidt_2e-1"],
                [0.6, "pos", "drop", "shear_flow", "shear_flow_Reynolds_1e5_Schmidt_2e-1"],
                [0.6, "neg", "pad", "shear_flow", "shear_flow_Reynolds_1e5_Schmidt_2e-1"],
                [0.6, "pos", "pad", "shear_flow", "shear_flow_Reynolds_1e5_Schmidt_2e-1"],
    ...
    for i, isign, itype, dset, fname in run_list: 
        ...
        experiment_name = fname+f"[{inject_sign}-{inject_type}@{injection_strength}][vortex]" 
        ...
        with initialize(version_base=None, config_path="walrus_steering/configs/", job_name=run_name):
            cfg = compose(config_name="config",
                        overrides=[f"name=\"{run_name}\"",
                                ...
                                #   f"save_activations='{fname}[FullRes]'",      
